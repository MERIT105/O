...
def create_random_key():
    key = "MALAYALI-" + ''.join(random.choice(string.ascii_uppercase + string.digits) for _ in range(10))
...
def start_command(message):
    ...
    bot.reply_to(message, "𝗪𝗘𝗟𝗖𝗢𝗠𝗘 𝗧𝗢 ┊⪼ꮇá𝗅áɏáļḭ⪻┊™ 𝐃𝐃𝐎𝐒 𝐖𝐎𝐑𝐋𝐃!", reply_markup=markup)
    
admin_id = {"5712886230","919737611"}  # Existing admin IDs
users = {}
coins = {}
